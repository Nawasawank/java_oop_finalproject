...
public class English3 extends JPanel implements ItemListener,ActionListener {
	JRadioButton b1 = new JRadioButton("a. loyal ");
	JRadioButton b2 = new JRadioButton("b. stable");
	JRadioButton b3 = new JRadioButton("c. efficient");
	JRadioButton b4 = new JRadioButton("d. limited");
	JPanel p1 = new JPanel();
	JPanel p2 = new JPanel();
	JLabel l1 = new JLabel("Takeshi's job with the government is ___ . He'll\r\n"
			+ "probably work there until he retires.");
	String message = "";
	JButton next = new JButton("Next");
	JPanel p3 = new JPanel();
	JFrame frame = new JFrame("Math Question3");
	int check = 0;
