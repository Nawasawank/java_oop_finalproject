...
public class English2 extends JPanel implements ItemListener,ActionListener {
	JRadioButton b1 = new JRadioButton("a. operational");
	JRadioButton b2 = new JRadioButton("b. maximal ");
	JRadioButton b3 = new JRadioButton("c. addictive");
	JRadioButton b4 = new JRadioButton("d. courteous");
	JPanel p1 = new JPanel();
	JPanel p2 = new JPanel();
	JLabel l1 = new JLabel("Cigarettes are ___ . Once you start smoking, it is\r\n"
			+ "difficult to quit.");
	String message = "";
	JButton next = new JButton("Next");
	JPanel p3 = new JPanel();
	JFrame frame = new JFrame("English Question2");
	int check = 0;
